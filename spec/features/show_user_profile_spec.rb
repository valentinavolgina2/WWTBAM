...
RSpec.feature 'show user profile', type: :feature do
  ...
  let!(:games) { [
    create(:game, user: user, created_at: '2022.01.01 11:00', prize: 1000, current_level: 3, fifty_fifty_used: true),
    create(:game, user: user, created_at: '2022.03.04 15:00', prize: 0, current_level: 0, is_failed: true, finished_at: '2021.03.04 15:05')] }
